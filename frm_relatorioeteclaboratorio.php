...
?>
<form id="form1" name="form1" method="post" action="op_relatorioeteclaboratorio.php?us=<?php //$us= base64_decode($us); 
echo $us ?>">
  <table width="933" border="0" align="center">
    <tr>
      <td colspan="2" align="center"><strong>Relatório Laboratório Etec</strong></td>
    </tr>
    <tr>
      <td width="669" align="left"><strong>Etec</strong></td>
      <td width="253">&nbsp;</td>
    </tr>
    <tr>
      <td align="left"><label>
